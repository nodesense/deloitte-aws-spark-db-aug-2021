...
fileRdd = sc.textFile('/FileStore/tables/wordcount/book.txt')
...
wordsListRdd.collect() # returns list of list of words
...
wordCountRdd.saveAsTextFile('/FileStore/tables/wordcount/results')
